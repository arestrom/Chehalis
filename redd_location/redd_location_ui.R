...
redd_location_ui = tags$div(
  ...
  br(),
  br(),
  textInput(inputId = "redd_name_input", label = "Redd Name", width = "125px"),
  uiOutput("redd_channel_type_select", inline = TRUE),
  uiOutput("redd_orientation_type_select", inline = TRUE),
  ...
  numericInput(inputId = "redd_horiz_accuracy_input", label = "Horiz. Accuracy", value = NULL,
               min = 0, width = "110px"),
  textAreaInput(inputId = "redd_location_description_input", label = "Location Description", value = "",

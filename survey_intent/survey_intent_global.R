...
survey_intent_insert = function(new_intent_values) {
  ...
  insert_result = dbSendStatement(
    con, glue_sql("INSERT INTO spawning_ground.survey_intent (",
                  "survey_id, ",
                  "species_id, ",
                  "count_type_id, ",
                  "created_by) ",
...
survey_intent_update = function(intent_edit_values) {
  ...
  update_result = dbSendStatement(
    con, glue_sql("UPDATE spawning_ground.survey_intent SET ",
                  "species_id = $1, ",
                  "count_type_id = $2, ",
                  "modified_datetime = $3, ",
                  "modified_by = $4 ",
...
survey_intent_delete = function(delete_values) {
  ...
  delete_result = dbSendStatement(
    con, glue_sql("DELETE FROM spawning_ground.survey_intent WHERE survey_intent_id = $1"))

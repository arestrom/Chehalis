...
get_redd_substrate = function(redd_encounter_id) {
  qry = glue("select rs.redd_substrate_id, sl.substrate_level_short_description as substrate_level, ",
             ...
             "from spawning_ground.redd_substrate as rs ",
             "left join spawning_ground.substrate_level_lut as sl on rs.substrate_level_id = sl.substrate_level_id ",
             "left join spawning_ground.substrate_type_lut as st on rs.substrate_type_id = st.substrate_type_id ",
...
redd_substrate_insert = function(new_redd_substrate_values) {
  ...
  insert_result = dbSendStatement(
    con, glue_sql("INSERT INTO spawning_ground.redd_substrate (",
                  "redd_encounter_id, ",
                  "substrate_level_id, ",
                  "substrate_type_id, ",
                  "substrate_percent, ",
...
redd_substrate_update = function(redd_substrate_edit_values) {
  ...
  update_result = dbSendStatement(
    con, glue_sql("UPDATE spawning_ground.redd_substrate SET ",
...
redd_substrate_delete = function(delete_values) {
  ...
  delete_result = dbSendStatement(
    con, glue_sql("DELETE FROM spawning_ground.redd_substrate ",
                  "WHERE redd_substrate_id = $1"))

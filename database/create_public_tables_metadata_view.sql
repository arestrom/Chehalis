...
WHERE
    cols.table_catalog    = 'spawning_ground'
--    AND cols.table_name   = 'survey'
    AND cols.table_schema = 'public';

-- Set permissions
-- ALTER TABLE public_tables_metadata OWNER TO xxxx;
-- GRANT SELECT, UPDATE, INSERT, DELETE, REFERENCES, TRIGGER ON TABLE public_tables_metadata TO xxxx;
